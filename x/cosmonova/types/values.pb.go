...
// source: cosmonova/cosmonova/values.proto
...
type Values struct {
	...
	ValidatorPower uint64 `protobuf:"varint,2,opt,name=validatorPower,proto3" json:"validatorPower,omitempty"`
...
func (*Values) Descriptor() ([]byte, []int) {
	return fileDescriptor_d35c0c9b507c8d4f, []int{0}
}
...
func (m *Values) GetValidator() string {
	if m != nil {
		return m.Validator
	}
	return ""
...
func (m *Values) GetValidatorPower() uint64 {
	if m != nil {
...
func (m *Values) GetTimestamp() uint64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func init() {
	proto.RegisterType((*Values)(nil), "cosmonova.cosmonova.Values")
}

func init() { proto.RegisterFile("cosmonova/cosmonova/values.proto", fileDescriptor_d35c0c9b507c8d4f) }

var fileDescriptor_d35c0c9b507c8d4f = []byte{
	// 180 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Values) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Timestamp != 0 {
		i = encodeVarintValues(dAtA, i, uint64(m.Timestamp))
		i--
		dAtA[i] = 0x20
	}
	if m.Val != 0 {
		i = encodeVarintValues(dAtA, i, uint64(m.Val))
		i--
		dAtA[i] = 0x18
	}
	if m.ValidatorPower != 0 {
		i = encodeVarintValues(dAtA, i, uint64(m.ValidatorPower))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Validator) > 0 {
		...
		i = encodeVarintValues(dAtA, i, uint64(len(m.Validator)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Values) Size() (n int) {
	...
	if m.ValidatorPower != 0 {
		n += 1 + sovValues(uint64(m.ValidatorPower))
	}
	if m.Val != 0 {
		n += 1 + sovValues(uint64(m.Val))
	}
	if m.Timestamp != 0 {
		n += 1 + sovValues(uint64(m.Timestamp))
	}
	return n
}
